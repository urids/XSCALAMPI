...
dnl 
dnl Generated by uriel at Sat Jul  7 22:24:38 2018
...
m4_define([mca_opal_crs_m4_config_component_list], [blcr, self, dmtcp])
...
m4_define([mca_opal_if_m4_config_component_list], [bsdx_ipv4, posix_ipv4, solaris_ipv6, linux_ipv6, bsdx_ipv6])
...
m4_define([mca_opal_shmem_m4_config_component_list], [sysv, mmap, posix])
m4_define([mca_opal_shmem_no_config_component_list], [])

dnl Components in the opal / timer framework
m4_define([mca_opal_timer_m4_config_component_list], [solaris, altix, linux, darwin, aix, catamount])
...
m4_define([mca_orte_errmgr_no_config_component_list], [default_hnp, default_app, default_tool, default_orted])

dnl Components in the orte / ess framework
m4_define([mca_orte_ess_m4_config_component_list], [alps, slurm, pmi, tm, lsf])
m4_define([mca_orte_ess_no_config_component_list], [hnp, tool, singleton, env])
...
m4_define([mca_orte_plm_m4_config_component_list], [alps, rsh, slurm, tm, isolated, lsf])
m4_define([mca_orte_plm_no_config_component_list], [])

dnl Components in the orte / ras framework
m4_define([mca_orte_ras_m4_config_component_list], [loadleveler, alps, slurm, gridengine, tm, lsf])
...
m4_define([mca_orte_rmaps_no_config_component_list], [resilient, staged, ppr, seq, round_robin])
...
m4_define([mca_orte_routed_no_config_component_list], [debruijn, radix, binomial, direct])

dnl Components in the orte / sensor framework
m4_define([mca_orte_sensor_m4_config_component_list], [heartbeat, file, ft_tester, resusage])
...
m4_define([mca_orte_state_no_config_component_list], [hnp, tool, novm, app, orted, staged_hnp, staged_orted])
...
m4_define([mca_ompi_common_m4_config_component_list], [cuda, verbs, mx, ugni, sm])
...
m4_define([mca_ompi_btl_m4_config_component_list], [smcuda, usnic, vader, scif, portals4, ugni, sm, tcp, openib])
m4_define([mca_ompi_btl_no_config_component_list], [self])

dnl Components in the ompi / coll framework
m4_define([mca_ompi_coll_m4_config_component_list], [fca, portals4, hcoll, hierarch])
m4_define([mca_ompi_coll_no_config_component_list], [ml, inter, tuned, libnbc, self, basic, sm])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [two_phase, dynamic, individual, ylib, static])
...
m4_define([mca_ompi_mpool_m4_config_component_list], [rgpusm, udreg, gpusm])
m4_define([mca_ompi_mpool_no_config_component_list], [grdma, sm])

dnl Components in the ompi / mtl framework
m4_define([mca_ompi_mtl_m4_config_component_list], [psm, mxm, mx, portals4])
...
m4_define([mca_ompi_pml_m4_config_component_list], [v, ob1, bfo, crcpw])
...
m4_define([ompi_mpiext_list], [affinity, XCLFrame, cr])

dnl List of configure.m4 files to include
m4_include([ompi/mpiext/affinity/configure.m4])
m4_include([ompi/mpiext/XCLFrame/configure.m4])
