...
AC_DEFUN([OMPI_MPIEXT_XCLFrame_CONFIG],[
    ...
    AC_CONFIG_FILES([ompi/mpiext/XCLFrame/Scheduling/DynamicSched/Makefile])
    AC_CONFIG_FILES([ompi/mpiext/XCLFrame/Scheduling/DynamicSched/DefaultDynamic/Makefile])
